                                    ...
                                    <div class="leave-app-form-leavetype-container">
                                        ...
                                        <div class="leave-app-form-leavetype-detail-container">
                                            <input type='radio' id="maternityLeave" name="typeOfLeave"
                                                value="Maternity Leave" class="custom-checkbox-input" <?php echo $leaveAppFormData['typeOfLeave'] === 'Maternity Leave' ? 'checked' : ''; ?>
                                                readonly />
                                        ...
                                        <div class="leave-app-form-leavetype-detail-container">
                                            <input type='radio' id="paternityLeave" name="typeOfLeave"
                                                value="Paternity Leave" class="custom-checkbox-input" <?php echo $leaveAppFormData['typeOfLeave'] === 'Paternity Leave' ? 'checked' : ''; ?>
                                                readonly />
                                        ...
                                        <div class="leave-app-form-leavetype-detail-container">
                                            <input type='radio' id="soloParent" name="typeOfLeave" value="Solo Parent Leave"
                                                class="custom-checkbox-input" <?php echo $leaveAppFormData['typeOfLeave'] === 'Solo Parent Leave' ? 'checked' : ''; ?>
                                                readonly />
                                        ...
                                        <div class="leave-app-form-leavetype-detail-container">
                                            <input type='radio' id="vawcLeave" name="typeOfLeave" value="10-Day VAWC Leave"
                                                class="custom-checkbox-input" <?php echo $leaveAppFormData['typeOfLeave'] === '10-Day VAWC Leave' ? 'checked' : ''; ?>
                                                readonly />
                                        ...
                                        <div class="leave-app-form-leavetype-detail-container">
                                            <input type='radio' id="specialLeave" name="typeOfLeave"
                                                value="Special Leave Benefits for Women" class="custom-checkbox-input" <?php echo $leaveAppFormData['typeOfLeave'] === 'Special Leave Benefits for Women' ? 'checked' : ''; ?> readonly />
