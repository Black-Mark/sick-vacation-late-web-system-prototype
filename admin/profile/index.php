...
<body class="webpage-background-cover-admin">
    ...
    <div class="page-container">
        <div class="page-content">
            ...
            <!-- Edit Modal -->
            <form action="<?php echo $action_edit_employee; ?>" method="post" class="modal fade custom-scrollbar"
                id="editEmployee" tabindex="-1" role="dialog" aria-labelledby="editEmployeeTitle" aria-hidden="true">
