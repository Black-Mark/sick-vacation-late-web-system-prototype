                            ...
                            <div class="modal-body">
                                    ...
                                    <div class="col-md">
                                        <div class="form-floating">
                                            <select name="sex" class="form-select" id="floatingSex"
                                                ...
                                                <option value="Male"
                                                    <?php echo $employeeData['sex'] == "Male" ? 'selected' : ''; ?>>Male
                                                </option>
                                                <option value="Female"
                                                    <?php echo $employeeData['sex'] == "Female" ? 'selected' : ''; ?>>
                                                    Female</option>
                                            </select>
                                        ...
                                        <div class="form-floating">
                                            <select name="civilStatus" class="form-select" id="floatingCivilStatus"
                                                ...
                                                <option value="Married"
                                                    <?php echo $employeeData['civilStatus'] == "Married" ? 'selected' : ''; ?>>
                                                    Married
                                                </option>
                                                <option value="Widowed"
                                                    <?php echo $employeeData['civilStatus'] == "Widowed" ? 'selected' : ''; ?>>
                                                    Widowed
                                                </option>
                                                <option value="Divorced"
                                                    <?php echo $employeeData['civilStatus'] == "Divorced" ? 'selected' : ''; ?>>
                                                    Divorced</option>
                                            </select>
                                ...
                                <div class="form-floating mb-2">
                                    <input type="date" name="birthdate" class="form-control" id="floatingBirthdate"
                                        placeholder="01-01-2001" min="<?php echo $minDate; ?>"
                                        max="<?php echo $loweredDateRange; ?>"
                                        value="<?php echo $employeeData['birthdate']; ?>" required>
                                ...
                                <div class="form-floating mb-2">
                                    <select name="jobPosition" class="form-select" id="floatingJobPosition"
                                        ...
                                        <option title="<?php echo $designation['designationDescription']; ?>"
                                            ...
                                            <?php echo $employeeData['jobPosition'] == $designation['designation_id'] ? 'selected' : ''; ?>>
                                ...
                                <div class="form-floating mb-2">
                                    <input type="date" name="dateStarted" class="form-control" id="floatingDateStarted"
                                        placeholder="12-31-2001" min="<?php echo $minDate; ?>"
                                        max="<?php echo $firstDayNextMonth; ?>"
                                                    ...
                                                    <div class="col-md">
                                                        <div class="form-floating">
                                                            <input type="number" min="1924" max="3000" step="1"
                                                                ...
                                                                placeholder="2023">
                                                            <label for="floatingCollegePeriodEnd">Period of
                                                                Attendance
                                                                To</label>
                                                        </div>
                                                    </div>
