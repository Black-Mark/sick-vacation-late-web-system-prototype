                                    ...
                                    <?php if ($leaveAppFormData['typeOfLeave'] === "Special Privilege Leave") { ?>
                                        <div id="splLeave" class="leave-app-form-inclusivedate-detail-container">
                                            ...
                                            <div class="leave-app-form-inclusivedate-input-container">
                                                <input disabled type="date" id="inclusiveDateSelectOne" name="inclusiveDateSelectOne"
                                                    class='leave-app-form-input-plain' value="<?php echo $leaveAppFormData['inclusiveDateOne']; ?>" />
                                                <input disabled type="date" id="inclusiveDateSelectTwo" name="inclusiveDateSelectTwo"
                                                    class='leave-app-form-input-plain' value="<?php echo $leaveAppFormData['inclusiveDateTwo']; ?>" />
