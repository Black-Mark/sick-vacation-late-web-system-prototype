        ...
        <div class="page-content">
            ...
            <div class='box-container'>
                ...
                <div class="button-container component-container mb-2">
                    <input type="hidden" name="recordId" value="<?php echo $leaveAppFormData['leaveappform_id']; ?>" />
                                ...
                                <tr>
                                    <td class="pb-1 px-2">
                                        <input type="text" id="department" name="departmentName"
                                            ...
                                            value="<?php echo $leaveAppFormData['departmentName']; ?>"  />
                                    </td>
                                    <td></td>
                                    <td class="pb-1 px-2"><input type="text" id="lastNameInput" name="lastName"
                                            class='w-100 text-center underline-input'
                                            value="<?php echo $leaveAppFormData['lastName']; ?>"  /></td>
                                    <td class="pb-1 px-2"><input type="text" id="firstNameInput" name="firstName"
                                            class='w-100 text-center underline-input' value="<?php echo $leaveAppFormData['firstName']; ?>" /></td>
                                    <td class="pb-1 px-2"><input type="text" id="middleNameInput" name="middleName"
                                            class='w-100 text-center underline-input' value="<?php echo $leaveAppFormData['middleName']; ?>" /></td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                <tr>
                                    <td class="pb-1 px-2"><label for="dateFiling">3. Date Of Filing </label><input
                                            type="text" id="dateFiling" name="dateFiling" class='underline-input text-center' value="<?php echo $leaveAppFormData['dateFiling']; ?>" />
                                    </td>
                                    <td class="pb-1 px-2"><label for="position">4. Position </label><input type="text"
                                            id="position" name="position" class='underline-input text-center' value="<?php echo $leaveAppFormData['position']; ?>" />
                                    </td>
                                    <td class="pb-1 px-2"><label for="salary">5. Salary </label><input type="text"
                                            id="salary" name="salary" class='underline-input text-center' value="<?php echo $leaveAppFormData['salary']; ?>"  />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                                    ...
                                    <td class="col-6 custom-td">
                                        ...
                                        <div>
                                            <input type='radio' id="maternityLeave" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Maternity Leave' ? 'checked' : ''; ?>  /> <label for="maternityLeave"
                                        ...
                                        <div>
                                            <input type='radio' id="paternityLeave" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Paternity Leave' ? 'checked' : ''; ?>  /> <label for="paternityLeave"
                                                class='font-weight-bold'>
                                                Paternity Leave
                                            </label>
                                            <span>
                                        ...
                                        <div>
                                            <input type='radio' id="special" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Special Privilege Leave' ? 'checked' : ''; ?>  /> <label for="special"
                                                class='font-weight-bold'>
                                        ...
                                        <div>
                                            <input type='radio' id="soloParent" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Solo Parent Leave' ? 'checked' : ''; ?>  /> <label for="soloParent"
                                                class='font-weight-bold'>
                                                Solo Parent Leave
                                            </label>
                                            <span>
                                        ...
                                        <div>
                                            <input type='radio' id="studyLeave" name="typeOfLeave"
                                                value="Study Leave"
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Study Leave' ? 'checked' : ''; ?>  /> <label for="studyLeave" class='font-weight-bold'>
                                        ...
                                        <div>
                                            <input type='radio' id="vawcLeave" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == '10-Day VAWC Leave' ? 'checked' : ''; ?>  /> <label for="vawcLeave"
                                                class='font-weight-bold'>
                                                10-Day VAWC Leave
                                            </label>
                                            <span>
                                        ...
                                        <div>
                                            <input type='radio' id="rehabilitation" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Rehabilitation Privilege' ? 'checked' : ''; ?>  /> <label for="rehabilitation"
                                                class='font-weight-bold'>
                                        ...
                                        <div>
                                            <input type='radio' id="specialLeave" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Special Leave Benefits for Women' ? 'checked' : ''; ?>  /> <label for="specialLeave"
                                                class='font-weight-bold'>
                                        ...
                                        <div>
                                            <input type='radio' id="emergencyLeave" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Solo Parent Leave' ? 'checked' : ''; ?>  /> <label
                                        ...
                                        <div>
                                            <input type='radio' id="adoptionLeave" name="typeOfLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfLeave'] == 'Adoption Leave' ? 'checked' : ''; ?>  /> <label for="adoptionLeave"
                                                class='font-weight-bold'>
                                                Adoption Leave
                                            </label>
                                            <span>
                                    ...
                                    <td class='col-4 custom-td'>
                                        ...
                                        <div>
                                            <input type='radio' id="withinPhi" name="typeOfVacationLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfVacationLeave'] == 'Within the Philippines' ? 'checked' : ''; ?>  /> <label for="withinPhi"
                                                class='font-weight-bold'>
                                                Within the Philippines <input type="text"
                                                    name="typeOfVacationLeaveWithin"
                                                    class='custom-underline-input-form' value="<?php echo $leaveAppFormData['typeOfVacationLeaveWithin']; ?>"  />
                                            </label>
                                        </div>
                                        <div>
                                            ...
                                            <label for="abroad" class='font-weight-bold'>
                                                Abroad (Specify) <input type="text" name="typeOfVacationLeaveAbroad"
                                                    class='custom-underline-input-form' value="<?php echo $leaveAppFormData['typeOfVacationLeaveAbroad']; ?>"  />
                                            </label>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <input type='radio' id="inHospital" name="typeOfSickLeave"
                                                value="In Hospital"
                                                <?php echo $leaveAppFormData['typeOfSickLeave'] == 'In Hospital' ? 'checked' : ''; ?>  /> <label for="inHospital" class='font-weight-bold'>
                                                In Hospital (Specify Illness) <input type="text"
                                                    name="typeOfSickLeaveInHospital" class='custom-underline-input' value="<?php echo $leaveAppFormData['typeOfSickLeaveInHospital']; ?>"  />
                                            </label>
                                        </div>
                                        <div>
                                            <input type='radio' id="outPatient" name="typeOfSickLeave"
                                                value="Out Patient"
                                                <?php echo $leaveAppFormData['typeOfSickLeave'] == 'Out Patient' ? 'checked' : ''; ?>  /> <label for="outPatient" class='font-weight-bold'>
                                                Out Patient (Specify Illness) <input type="text"
                                                    name="typeOfSickLeaveOutPatient" class='custom-underline-input' value="<?php echo $leaveAppFormData['typeOfSickLeaveOutPatient']; ?>"  />
                                            </label>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            <label for="specifyIllness" class='font-weight-bold'>
                                                ...
                                                class='custom-underline-input-form-detail' value="<?php echo $leaveAppFormData['typeOfSpecialLeaveForWomen']; ?>"  />
                                        ...
                                        <div>
                                            <input type='radio' id="mastersDegree" name="typeOfStudyLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfStudyLeave'] == 'Completion of Master Degree' ? 'checked' : ''; ?>  /> <label for="mastersDegree"
                                                class='font-weight-bold'>
                                        ...
                                        <div>
                                            <input type='radio' id="boardExam" name="typeOfStudyLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfStudyLeave'] == 'Board Examination Review' ? 'checked' : ''; ?>  /> <label for="boardExam"
                                                class='font-weight-bold'>
                                        ...
                                        <div>
                                            <input type='radio' id="terminalLeave" name="typeOfOtherLeave"
                                                ...
                                                <?php echo $leaveAppFormData['typeOfOtherLeave'] == 'Terminal Leave' ? 'checked' : ''; ?>  /> <label for="terminalLeave"
                                                class='font-weight-bold'>
                                                Terminal Leave
                                            </label>
                                        </div>
                                    ...
                                    <td class="col-6 custom-td">
                                        ...
                                        <div>
                                            <input type="number" min="0" max="3652" id="workingDays" name="workingDays"
                                                class='w-100 text-center custom-underline-input-form' value="<?php echo $leaveAppFormData['workingDays']; ?>"  />
                                        </div>
                                        ...
                                        <div>
                                            <input type="text" id="inclusiveDates" name="inclusiveDates"
                                                class='w-100 text-center custom-underline-input-form' value="<?php echo $leaveAppFormData['inclusiveDates']; ?>"  />
                                        </div>
                                    </td>
                                    <td class="col-4 custom-td">
                                        ...
                                        <div>
                                            <input type='radio' id="notRequested" name="commutation"
                                                value="Not Requested"
                                                <?php echo $leaveAppFormData['commutation'] == 'Not Requested' ? 'checked' : ''; ?>  /> <label for="notRequested"
                                                class='font-weight-bold'>
                                                Not Requested
                                            </label>
                                        </div>
                                    ...
                                    <td class="col-6 custom-td">
                                        ...
                                        <div class='text-center'>
                                            <label for="asOfDate">As of</label> <input type="date"
                                                ...
                                                name="asOfDate" class='underline-input text-center'  />
                                        </div>
                                                ...
                                                <tbody>
                                                    <tr class='text-center'>
                                                        ...
                                                        <td><input type="number" name="vacationLeaveTotalEarned"
                                                                class='custom-input-leave-form' value="<?php echo $leaveAppFormData['vacationLeaveTotalEarned']; ?>"  /></td>
                                                        <td><input type="number" name="sickLeaveTotalEarned"
                                                                class='custom-input-leave-form' value="<?php echo $leaveAppFormData['sickLeaveTotalEarned']; ?>"  /></td>
                                                    </tr>
                                                    <tr class='text-center'>
                                                        <td class='font-italic'>Less this application</td>
                                                        <td><input type="number" name="vacationLeaveLess"
                                                                class='custom-input-leave-form' value="<?php echo $leaveAppFormData['vacationLeaveLess']; ?>"  /></td>
                                                        <td><input type="number" name="sickLeaveLess"
                                                                class='custom-input-leave-form' value="<?php echo $leaveAppFormData['sickLeaveLess']; ?>"  /></td>
                                                    </tr>
                                                    <tr class='text-center'>
                                                        <td class='font-italic'>Balance</td>
                                                        <td><input type="number" name="vacationLeaveBalance"
                                                                class='custom-input-leave-form' value="<?php echo $leaveAppFormData['vacationLeaveBalance']; ?>"  /></td>
                                                        <td><input type="number" name="sickLeaveBalance"
                                                                class='custom-input-leave-form' value="<?php echo $leaveAppFormData['sickLeaveBalance']; ?>"  /></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <td class='col-4 custom-td'>
                                        ...
                                        <div>
                                            <input type='radio' id="forApproval" name="recommendation"
                                                value="For Approval"
                                                <?php echo $leaveAppFormData['recommendation'] == 'For Approval' ? 'checked' : ''; ?>  /> <label for="forApproval"
                                                class='font-weight-bold'>
                                                For Approval
                                            </label>
                                        </div>
                                        <div>
                                            <input type='radio' id="forDisapprovedDueToApproval" name="recommendation"
                                                ...
                                                <?php echo $leaveAppFormData['recommendation'] == 'For Disapproved Due to' ? 'checked' : ''; ?>  /> <label
                                                for="forDisapprovedDueToApproval" class='font-weight-bold'>
                                                For Disapproved Due to </label> <input type="text"
                                                name="recommendMessage" class='custom-underline-input-form' value="<?php echo $leaveAppFormData['recommendMessage']; ?>"  />
                                    ...
                                    <td class="col-6">
                                        ...
                                        <div>
                                            <input id="dayWithPay" type="number" name="dayWithPay"
                                                class='underline-input' value="<?php echo $leaveAppFormData['dayWithPay']; ?>"  /><label for="dayWithPay"> days with
                                                pay</label>
                                        </div>
                                        <div>
                                            <input id="dayWithoutPay" type="number" name="dayWithoutPay"
                                                class='underline-input' value="<?php echo $leaveAppFormData['dayWithoutPay']; ?>"  /><label for="dayWithoutPay"> days without
                                                pay</label>
                                        </div>
                                        <div>
                                            <input id="otherPay" type="number" name="otherDayPay"
                                                class='underline-input' value="<?php echo $leaveAppFormData['otherDayPay']; ?>"  /> <label for="otherPay">Others</label>
                                            <label for="otherPaySpecify">(Specify)</label>
                                            <input type="text" id="otherPaySpecify" name="otherDaySpecify"
                                                class='underline-input' value="<?php echo $leaveAppFormData['otherDaySpecify']; ?>"  />
                                        </div>
                                    </td>
                                    <td class="col-4">
                                        <div class='font-weight-bold text-uppercase'>
                                        ...
                                        <div><input type="text" name="disapprovedMessage"
                                                class='w-100 underline-input' value="<?php echo $leaveAppFormData['disapprovedMessage']; ?>"  /></div>
                                        <div><input class='w-100 underline-input' disabled /></div>
                                        <div><input class='w-100 underline-input' disabled /></div>
                                    </td>
                                </tr>
