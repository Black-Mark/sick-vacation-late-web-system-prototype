<div class='tab-nav-container custom-scrollbar'>
    ...
    <a title="Employee Information" href="<?php echo $location_admin_departments_employee . '/' . $empId . '/'; ?>"
        class="tab-nav-button <?php echo ($_SERVER['SCRIPT_NAME'] === $location_admin_departments_employee . '/index.php') ? 'active-tab-nav text-white' : ''; ?>">
    ...
    <a title="Leave Data Form"
        ...
        class="tab-nav-button <?php echo ($_SERVER['SCRIPT_NAME'] === $location_admin_departments_employee_leavedataform . '/index.php') ? 'active-tab-nav text-white' : ''; ?>">
        Leave Data Form
    </a>
</div>