...
if (strtolower($leaveAppFormData['status']) == "submitted") {
    $limitDayOfExpiry = 5;
    if ($leaveAppFormData['typeOfLeave'] == 'Rehabilitation Privilege') {
    ...
    <div class="page-container">
        <div class="page-content">
            ...
            <div class='box-container'>
                ...
                <?php if ($notAvailable) { ?>
                    <div class="text-center alert alert-warning" role="alert"><?php echo $availabilityMessage; ?></div>
                <?php } ?>
                                ...
                                <div class="leave-app-form-container">
                                    ...
                                    <div class="leave-app-form-first-row">
                                        ...
                                        <div class="leave-app-form-fullname-input-container">
                                            <div>
                                                <div class="leave-app-form-name-container leave-app-form-label">2. Name:
                                                </div>
                                            </div>
                                    ...
                                    <div class="leave-app-form-third-row">
                                        <div class="leave-app-form-leavetype-container">
                                            <div class='leave-app-form-third-row-head'>6.A Type of Leave to be Availed Of
                                            </div>
                                            ...
                                            <div class="leave-app-form-leavetype-detail-container">
                                                ...
                                                <span class="leave-app-form-leavetype-detail-context clickable-element"
                                                    data-toggle="modal" data-target="#vacationLeaveModal">
                                            ...
                                            <div class="leave-app-form-leavetype-detail-container">
                                                ...
                                                <span
                                                    class="leave-app-form-leavetype-detail-context-small clickable-element"
                                    ...
                                    <div class="leave-app-form-fourth-row">
                                        <div class="leave-app-form-inclusivedate-container">
                                            ...
                                            <div id="allLeave" <?php echo $leaveAppFormData['typeOfLeave'] != "Special Privilege Leave" ? 'style="display: block;"' : 'style="display: none;"' ?>
                                                class="leave-app-form-inclusivedate-detail-container">
                                            ...
                                            <div id="splLeave" <?php echo $leaveAppFormData['typeOfLeave'] == "Special Privilege Leave" ? 'style="display: block;"' : 'style="display: block;"' ?>
                                                class="leave-app-form-inclusivedate-detail-container">
                                        ...
                                        <div class="leave-app-form-commutation-container">
                                            ...
                                            <div class="leave-app-form-signature-container">
                                                <!-- <input <?php echo $notAvailable ? 'disabled' : ''; ?> class="leave-app-form-input" disabled /> -->
                                    ...
                                    <div class="leave-app-form-fifth-row">
                                        <div class="leave-app-form-hrmanager-container">
                                            ...
                                            <div class="leave-app-form-leave-table-container">
                                                <div class="leave-app-form-leave-table-column-container">
                                                    ...
                                                    <div class="leave-app-form-leave-table-field">Less This Application
                                                    </div>
                                        ...
                                        <div class="leave-app-form-departmenthead-container">
                                            ...
                                            ?>
                                                ...
                                                ?> -->
                                                <div
                                                    class="leave-app-form-signature-context <?php echo $leaveAppFormData['deptHeadName'] == '' && $fullName == "" ? 'mt-4' : ''; ?>">
                                                </div>
                                                <div class='leave-app-form-signature-subject'>
                                                    <!-- Department Head -->
                                                    (Authorized Officer)
